...
db.serialize(() => {
    ...
    db.run(`
        CREATE TABLE IF NOT EXISTS itens_venda (
            ...
            FOREIGN KEY (id_venda_item_venda) REFERENCES vendas(id_venda)
        )
    `)

    // TABELA DE HISTÓRICO DE VENDAS (CORRIGIDA!)
    db.run(`
        CREATE TABLE IF NOT EXISTS historico_vendas (
            ...
            itens_historico_venda TEXT NOT NULL, -- COLUNA ADICIONADA AQUI PARA PARAR O ERRO 500
            ...
            FOREIGN KEY (id_venda_historico_venda) REFERENCES vendas(id_venda)
        )
    `)
})
